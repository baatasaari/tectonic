...
calls and get retry + circuit-breaking for free. This module's one
outbound dependency (Evaluation Framework) is a real, fixed-base_url
platform peer, so its client needs no per-target-URL breaker variant.
"""
