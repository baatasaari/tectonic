...
from llmops.clients.resilience import ResilientHTTPClient
from llmops.security.jwt_auth import ServiceBearerAuth
...
# max-size page as the canary gate's input rather than walking every page -- a bounded,
# most-recent-first sample is what a gate needs, not a version's entire lifetime record.
