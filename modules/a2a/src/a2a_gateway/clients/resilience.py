...
calls and get retry + circuit-breaking for free. `clients/a2a_peer_client.py`
calls a different absolute URL per registered peer agent, so it does not
subclass this — see its own docstring for why.
"""
