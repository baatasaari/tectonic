...
actually opens (and short-circuits) after repeated failures."""
import httpx
import pytest
import respx

from sdk_and_developer_portal.clients.resilience import CircuitBreakerError, ResilientHTTPClient
