...
from agent_cards.db.session import make_engine


def test_make_engine_applies_configured_pool_settings():
    settings = AgentCardsSettings(database_url="postgresql+asyncpg://u:p@localhost:5432/db")
