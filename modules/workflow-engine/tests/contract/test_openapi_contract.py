"""Real OpenAPI contract testing (Phase 1 gap: rollout of Billing and
Metering's own reference implementation, ticket #73/#80, to a second
module) -- `schemathesis` was already a listed dev dependency of every
module in this platform, but never actually invoked here before now.
