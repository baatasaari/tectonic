...
(Evaluation Framework, LLM Gateway).
...
calls and get retry + circuit-breaking for free. Both of this module's
outbound dependencies (Evaluation Framework, LLM Gateway) are real,
fixed-base_url platform peers, so their clients need no per-target-URL
breaker variant.
"""
